...
// End Cross Module References
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_ABloqueAcero_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ABloqueAcero>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ABloqueAcero_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_ABloqueAcero_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ABloqueAcero_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ABloqueAcero()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ABloqueAcero_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ABloqueAcero, 4140735149);
	template<> BOMBERMAN_012025_API UClass* StaticClass<ABloqueAcero>()
	{
		return ABloqueAcero::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABloqueAcero(Z_Construct_UClass_ABloqueAcero, &ABloqueAcero::StaticClass, TEXT("/Script/BomberMan_012025"), TEXT("ABloqueAcero"), false, nullptr, nullptr, nullptr);
